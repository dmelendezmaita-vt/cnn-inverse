...
REGISTRY_CSV = TABLES / f"a30_hh_track4_baseline_finalists_confirmation_registry_{DATE_TAG}.csv"
RUN_LOG_JSON = NOTES / f"a30_hh_track4_baseline_finalists_confirmation_run_log_{DATE_TAG}.json"
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Launch Track4 A30 baseline finalists confirmation rows inside an existing A30 allocation.")
