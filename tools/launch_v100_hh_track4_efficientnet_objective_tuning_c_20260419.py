...
REGISTRY_CSV = TABLES / f"v100_hh_track4_efficientnet_objective_tuning_c_registry_{DATE_TAG}.csv"
RUN_LOG_JSON = NOTES / f"v100_hh_track4_efficientnet_objective_tuning_c_run_log_{DATE_TAG}.json"
