...
def main() -> None:
    ...
    configs = {
        "snpe_maf_h192_t8": (
            "src/pytorch/configs/reruns_20260422_v100_hh_track4_checkpoint2_snpe_followup/track4_hh_full/params_t4cp2snpe_snpe_maf_h192_t8_s1201.yaml",
            "Top MAF follow-up by posterior-mean MSE.",
        ),
        "snpe_maf_h128_t8": (
            "src/pytorch/configs/reruns_20260422_v100_hh_track4_checkpoint2_snpe_followup/track4_hh_full/params_t4cp2snpe_snpe_maf_h128_t8_s1201.yaml",
            "Second-best MAF follow-up with stronger coverage.",
        ),
        "snpe_maf_h128_t5": (
            "src/pytorch/configs/reruns_20260422_v100_hh_track4_checkpoint2_snpe_followup/track4_hh_full/params_t4cp2snpe_snpe_maf_h128_t5_s1201.yaml",
            "Third-best MAF follow-up by posterior-mean MSE.",
        ),
        "snpe_nsf_h128_t5": (
            "src/pytorch/configs/reruns_20260422_v100_hh_track4_checkpoint2_snpe_followup/track4_hh_full/params_t4cp2snpe_snpe_nsf_h128_t5_s1201.yaml",
