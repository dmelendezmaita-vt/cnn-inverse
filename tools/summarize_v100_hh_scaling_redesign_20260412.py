...
SUMMARY_JSON = NOTES / f"v100_hh_scaling_redesign_summary_{DATE_TAG}.json"
SUMMARY_MD = NOTES / f"v100_hh_scaling_redesign_summary_{DATE_TAG}.md"
...
def main():
    ...
    md = [
        f"# V100 HH Scaling Redesign Summary ({DATE_TAG})",
        "",
