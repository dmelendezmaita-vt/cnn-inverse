...
from launch_a30_hh_track4_replication_20260420 import build_env, build_srun_cmd
...
def main() -> None:
    matrix = (
        REPO
        / "data/important_notes/optimization_track_20260420_a30_hh_track4_replication/tables"
        / "a30_hh_track4_replication_matrix_20260420_a30_hh_track4_replication.csv"
    )
    row = load_row(matrix, "a30t4rep_0001")

    env = build_env(row, "351880", "fal011", 29671, Path("/tmp/a30t4reptest"))
    ...
    print("A30_HH_TRACK4_REPLICATION_LAUNCH_TEST_OK")
