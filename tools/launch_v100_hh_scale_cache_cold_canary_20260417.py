...
def make_row(track_key: str, seed: int) -> dict[str, str]:
    if track_key == "track3_hh_reduced":
        return {
            ...
            "gpus_per_node": "2",
            "cpus_per_node": "24",
            "params_file": "src/pytorch/configs/reruns_20260416_v100_hh_datapath_redesign_r4/track3_hh_reduced/params_t3_R1_accum2_nosync_n4_s971.yaml",
    ...
    if track_key == "track4_hh_full":
        return {
            ...
            "gpus_per_node": "2",
            "cpus_per_node": "24",
            "params_file": "src/pytorch/configs/reruns_20260416_v100_hh_datapath_redesign_r4/track4_hh_full/params_t4_R1_accum2_nosync_n4_s971.yaml",
