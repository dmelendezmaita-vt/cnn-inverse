...
DATE_TAG = "20260419_v100_hh_track4_sub_length_retune"
...
MATRIX_CSV = TABLES / f"v100_hh_track4_sub_length_retune_matrix_{DATE_TAG}.csv"
NOTES_MD = NOTES / f"v100_hh_track4_sub_length_retune_notes_{DATE_TAG}.md"
...
def main() -> None:
    ...
    variants = {
        "base_sub2000": {
            "description": "Track4 sub-length retune baseline: g128/e400 sub2000.",
        ...
        "base_sub1000": {
            "description": "Track4 sub-length retune baseline: g128/e400 sub1000.",
            "learning_rate": "3.0e-4",
            "global_train_batch_size": "128",
            "train_batch_size": "128",
        ...
        "g64_lowlr_sub2000": {
            "description": "Track4 sub-length retune candidate: g64 low-lr sub2000.",
        ...
        "g64_lowlr_sub1000": {
            "description": "Track4 sub-length retune candidate: g64 low-lr sub1000.",
            "learning_rate": "1.5e-4",
            "global_train_batch_size": "64",
            "train_batch_size": "64",
            "features_sub_length": "1000",
    ...
    row_num = 0
    for seed in [981, 982]:
        group = f"track4_seed{seed}_sub_length"
        for strategy_id, variant in variants.items():
            ...
            updates = {
                "description": f'"{track_key} {strategy_id} sub-length retune {DATE_LABEL}"',
                ...
                "features_sub_length": variant["features_sub_length"],
            ...
            rows.append(
                {
                    "row_id": f"v100t4sl_{row_num:04d}",
                    "phase": "phaseI_track4_sub_length_retune",
                    "phase_label": "Track4 sub-length retune",
                    "launch_mode": "concurrent_4x1n",
                    "launch_group": group,
                    "family": "track4_sub_length_retune",
                    "track_key": track_key,
                    "policy": "strong",
                    "nodes": "1",
                    "gpus_per_node": "2",
                    ...
                    "notes": "Track4 sub-length retune around baseline and low-lr g64 candidate.",
                }
            )
    ...
    notes = [
        f"# V100 HH Track4 Sub-Length Retune ({DATE_LABEL})",
        "",
        f"- matrix csv: `{MATRIX_CSV}`",
        f"- rows: `{len(rows)}`",
        "",
        "## Purpose",
        "- test whether shorter temporal windows (`sub1000`) help the track4 baseline or low-lr g64 candidate",
        "- use fresh seeds 981-982 to keep the read clean",
    ]
    write_text(NOTES_MD, '\n'.join(notes) + '\n')
