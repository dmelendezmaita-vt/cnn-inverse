...
DATE_TAG = "20260421_a30_hh_track4_extra_trees_targeted_confirmation"
...
MATRIX_CSV = TABLES / f"a30_hh_track4_extra_trees_targeted_confirmation_matrix_{DATE_TAG}.csv"
NOTES_MD = NOTES / f"a30_hh_track4_extra_trees_targeted_confirmation_notes_{DATE_TAG}.md"
...
def main() -> None:
    ...
    baselines = {
        ...
        "extra_trees_500_leaf3": "ExtraTreesRegressor (500 trees, leaf=3, strongest balanced targeted-tuning candidate).",
    }

    rows = []
    row_num = 0
    for seed in [1083, 1084, 1085, 1086]:
        group = f"track4_a30_extra_trees_targeted_confirmation_seed_{seed}"
            ...
            rows.append(
                {
                    ...
                    "phase_label": "Track4 A30 extra trees targeted confirmation",
                    "launch_mode": "concurrent_4x1n",
                    "launch_group": group,
                    "family": "track4_a30_extra_trees_targeted_confirmation",
                    "track_key": track_key,
                    "policy": "strong",
                    "nodes": "1",
                    "cpus_per_node": "64",
                    ...
                    "notes": "Fresh-seed confirmation of the strongest targeted Extra Trees clean-data finalists.",
                }
            )
    ...
    notes = [
        f"# A30 HH Track4 Extra Trees Targeted Confirmation ({DATE_LABEL})",
        "",
        f"- matrix csv: `{MATRIX_CSV}`",
        f"- rows: `{len(rows)}`",
        "",
        "## Purpose",
        "- confirm the strongest targeted Extra Trees clean-data finalists on fresh seeds",
        "",
        "## Finalists",
