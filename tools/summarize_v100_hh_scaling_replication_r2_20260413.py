...
SUMMARY_JSON = NOTES / f"v100_hh_scaling_replication_r2_summary_{DATE_TAG}.json"
SUMMARY_MD = NOTES / f"v100_hh_scaling_replication_r2_summary_{DATE_TAG}.md"
...
def main():
    ...
    md = [
        f"# V100 HH Scaling Replication Summary ({DATE_TAG})",
        "",
