...
SUMMARY_JSON = NOTES / f"v100_hh_postlocalsgd_r3_stable_summary_{DATE_TAG}.json"
SUMMARY_MD = NOTES / f"v100_hh_postlocalsgd_r3_stable_summary_{DATE_TAG}.md"
...
def main():
    ...
    md = [
        f"# V100 HH Post-Local SGD R3 Stable Summary ({DATE_TAG})",
        "",
