...
DATE_TAG = "20260420_v100_hh_track4_effnet_invvar_stability"
...
MATRIX_CSV = TABLES / f"v100_hh_track4_effnet_invvar_stability_matrix_{DATE_TAG}.csv"
NOTES_MD = NOTES / f"v100_hh_track4_effnet_invvar_stability_notes_{DATE_TAG}.md"
...
def main() -> None:
    ...
    variants = {
        "avgpool_baseline": {
            "description": "Track4 invvar stability baseline: avg-pool ConvNet winner.",
            "type": '"ConvNet"',
        ...
        "effnet_beta005_invstd": {
            "description": "Track4 invvar stability candidate: EfficientNet beta=0.05 inverse_std.",
            "type": '"EfficientNet"',
            "dropout": "0.1",
            "target_loss_weight_mode": "inverse_std",
            "loss_type": "huber",
        ...
        "effnet_beta01_invstd": {
            "description": "Track4 invvar stability candidate: EfficientNet beta=0.1 inverse_std.",
            "type": '"EfficientNet"',
            "dropout": "0.1",
            "target_loss_weight_mode": "inverse_std",
            "loss_type": "huber",
        ...
        "effnet_beta005_invvar": {
            "description": "Track4 invvar stability candidate: EfficientNet beta=0.05 inverse_var.",
            "type": '"EfficientNet"',
            "dropout": "0.1",
    ...
    rows = []
    row_num = 0
    for seed in [1052, 1053, 1054, 1055, 1056, 1057]:
        group = f"track4_effnet_invvar_stability_seed_{seed}"
        for strategy_id, variant in variants.items():
            ...
            updates = {
                "description": f'"{track_key} {strategy_id} effnet invvar stability {DATE_LABEL}"',
                "type": variant["type"],
            ...
            rows.append(
                {
                    "row_id": f"v100t4eis_{row_num:04d}",
                    "phase": "phaseAJ_track4_effnet_invvar_stability",
                    "phase_label": "Track4 EfficientNet inverse-var stability",
                    "launch_mode": "concurrent_4x1n",
                    "launch_group": group,
                    "family": "track4_effnet_invvar_stability",
                    "track_key": track_key,
                    "policy": "strong",
                    "nodes": "1",
                    "gpus_per_node": "2",
                    ...
                    "notes": "Wider fresh-seed stability pass for the new EfficientNet inverse-var winner against the strongest nearby baselines.",
                }
            )
    ...
    notes = [
        f"# V100 HH Track4 EfficientNet Inverse-Var Stability ({DATE_LABEL})",
        "",
        f"- matrix csv: `{MATRIX_CSV}`",
        f"- rows: `{len(rows)}`",
        "",
        "## Purpose",
        "- stress-test whether the new EfficientNet inverse-var winner holds on a wider fresh-seed block",
        "",
        "## Variants",
        "- `avgpool_baseline`",
        "- `effnet_beta005_invstd`",
