...
from launch_v100_hh_track4_receptive_field_retune_20260419 import build_env, build_srun_cmd
...
def main() -> None:
    matrix = (
        REPO
        / "data/important_notes/optimization_track_20260419_v100_hh_track4_receptive_field_retune/tables"
        / "v100_hh_track4_receptive_field_retune_matrix_20260419_v100_hh_track4_receptive_field_retune.csv"
    )
    row = load_row(matrix, "v100t4rf_0001")

    env = build_env(row, "355055", "fal101", 29671, Path("/tmp/t4rftest"))
    ...
    print("V100_HH_TRACK4_RECEPTIVE_FIELD_RETUNE_LAUNCH_TEST_OK")
