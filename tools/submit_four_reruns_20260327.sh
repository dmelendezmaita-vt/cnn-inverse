...
CONFIG_ROOT="${REPO}/src/pytorch/configs/reruns_${DATE_TAG}"
...
for nodes, ntrain, gbs in [(1, 1000, 32), (2, 2000, 64), (4, 4000, 128)]:
    cfg_rel = f"src/pytorch/configs/reruns_20260327/track2_true_weak/params_t2_true_weak_a30_{nodes}n.yaml"
    create_config(
        track2_base,
        cfg_rel,
        {
...
for track_key, meta in track_meta.items():
    for lr, ep in lr_epoch_combos:
        ...
        cfg_rel = (
            f"src/pytorch/configs/reruns_20260327/{track_key}/"
