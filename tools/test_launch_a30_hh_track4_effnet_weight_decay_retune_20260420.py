...
from launch_a30_hh_track4_effnet_tail_schedule_retune_20260420 import build_env, build_srun_cmd
...
def main() -> None:
    matrix = (
        REPO
        / "data/important_notes/optimization_track_20260420_a30_hh_track4_effnet_tail_schedule_retune/tables"
        / "a30_hh_track4_effnet_tail_schedule_retune_matrix_20260420_a30_hh_track4_effnet_tail_schedule_retune.csv"
    )
    row = load_row(matrix, "a30t4tail_0001")

    env = build_env(row, "351880", "fal011", 29671, Path("/tmp/a30t4tailtest"))
    ...
    print("A30_HH_TRACK4_EFFNET_TAIL_SCHEDULE_RETUNE_LAUNCH_TEST_OK")
