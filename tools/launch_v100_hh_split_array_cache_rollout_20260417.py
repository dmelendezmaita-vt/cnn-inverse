...
DATE_TAG = "20260417_v100_hh_split_array_cache_rollout"
...
MATRIX_CSV = TABLES / f"v100_hh_split_array_cache_rollout_matrix_{DATE_TAG}.csv"
REGISTRY_CSV = TABLES / f"v100_hh_split_array_cache_rollout_registry_{DATE_TAG}.csv"
RUN_LOG_JSON = NOTES / f"v100_hh_split_array_cache_rollout_run_log_{DATE_TAG}.json"
