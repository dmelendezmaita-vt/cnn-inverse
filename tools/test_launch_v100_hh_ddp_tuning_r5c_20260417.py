...
from launch_v100_hh_ddp_tuning_r5c_20260417 import build_env, build_srun_cmd
...
def main() -> None:
    matrix = (
        REPO
        / "data/important_notes/optimization_track_20260417_v100_hh_ddp_tuning_r5c/tables"
        / "v100_hh_ddp_tuning_r5c_matrix_20260417_v100_hh_ddp_tuning_r5c.csv"
    )
    ...
    print("V100_HH_DDP_TUNING_R5C_LAUNCH_TEST_OK")
