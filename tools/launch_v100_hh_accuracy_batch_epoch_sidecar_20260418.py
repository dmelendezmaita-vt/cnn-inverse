...
REGISTRY_CSV = TABLES / f"v100_hh_accuracy_batch_epoch_sidecar_registry_{DATE_TAG}.csv"
RUN_LOG_JSON = NOTES / f"v100_hh_accuracy_batch_epoch_sidecar_run_log_{DATE_TAG}.json"
