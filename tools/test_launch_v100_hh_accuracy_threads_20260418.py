...
from launch_v100_hh_accuracy_threads_20260418 import build_env, build_srun_cmd
...
def main() -> None:
    matrix = (
        REPO
        / "data/important_notes/optimization_track_20260418_v100_hh_accuracy_threads/tables"
        / "v100_hh_accuracy_threads_matrix_20260418_v100_hh_accuracy_threads.csv"
    )
    row_1n = load_row(matrix, "v100acc_0001")

    env = build_env(row_1n, "355055", "fal101", 29671, "/tmp/accuracythreadtest")
    ...
    print("V100_HH_ACCURACY_THREADS_LAUNCH_TEST_OK")
