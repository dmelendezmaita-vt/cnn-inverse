...
from launch_a30_hh_track4_knn_robustness_tuning_20260421 import build_env, build_srun_cmd
...
def main() -> None:
    matrix = (
        REPO
        / "data/important_notes/optimization_track_20260421_a30_hh_track4_knn_robustness_tuning/tables"
        / "a30_hh_track4_knn_robustness_tuning_matrix_20260421_a30_hh_track4_knn_robustness_tuning.csv"
    )
    row = load_row(matrix, "a30t4knnr_0001")

    env = build_env(row, Path("/tmp/a30t4knnrtest"))
    if env.get("BASELINE_NAME") != "knn_k5":
    ...
    print("A30_HH_TRACK4_KNN_ROBUSTNESS_TUNING_LAUNCH_TEST_OK")
