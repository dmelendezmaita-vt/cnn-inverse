...
RUN_LOG_JSON = NOTES / f"v100_hh_datapath_redesign_r4_run_log_{DATE_TAG}.json"
        ...
        env.update(
            {
                ...
                "LAUNCH_BACKEND": os.environ.get("R4_V100_POSTLOCALSGD_LAUNCH_BACKEND", "slurm_direct"),
            }
        )
    return env
