...
RUN_LOG_JSON = NOTES / f"v100_hh_postlocalsgd_r3_stable_run_log_{DATE_TAG}.json"
    ...
    env.update(
        {
            ...
            "SKIP_INLINE_SPLIT_EVAL": "1",
            "LAUNCH_BACKEND": os.environ.get("R3_STABLE_LAUNCH_BACKEND", "slurm_direct"),
