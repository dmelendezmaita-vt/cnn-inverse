...
REGISTRY_CSV = TABLES / f"a30_hh_track4_extra_trees_tuning_registry_{DATE_TAG}.csv"
RUN_LOG_JSON = NOTES / f"a30_hh_track4_extra_trees_tuning_run_log_{DATE_TAG}.json"
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Launch Track4 A30 Extra Trees tuning rows inside an existing A30 allocation.")
