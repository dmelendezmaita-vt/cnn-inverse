...
from launch_v100_hh_track4_efficientnet_tuning_20260419 import build_env, build_srun_cmd
...
def main() -> None:
    matrix = (
        REPO
        / "data/important_notes/optimization_track_20260419_v100_hh_track4_efficientnet_tuning/tables"
        / "v100_hh_track4_efficientnet_tuning_matrix_20260419_v100_hh_track4_efficientnet_tuning.csv"
    )
    row = load_row(matrix, "v100t4eft_0001")

    env = build_env(row, "355055", "fal101", 29671, Path("/tmp/t4efttest"))
    ...
    print("V100_HH_TRACK4_EFFICIENTNET_TUNING_LAUNCH_TEST_OK")
