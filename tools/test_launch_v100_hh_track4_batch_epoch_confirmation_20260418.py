...
from launch_v100_hh_track4_batch_epoch_confirmation_20260418 import build_env, build_srun_cmd
...
def main() -> None:
    matrix = (
        REPO
        / "data/important_notes/optimization_track_20260418_v100_hh_track4_batch_epoch_confirmation/tables"
        / "v100_hh_track4_batch_epoch_confirmation_matrix_20260418_v100_hh_track4_batch_epoch_confirmation.csv"
    )
    row_1n = load_row(matrix, "v100t4be_0001")

    env = build_env(row_1n, "355055", "fal101", 29671, "/tmp/t4batchepochtest")
    ...
    print("V100_HH_TRACK4_BATCH_EPOCH_CONFIRMATION_LAUNCH_TEST_OK")
