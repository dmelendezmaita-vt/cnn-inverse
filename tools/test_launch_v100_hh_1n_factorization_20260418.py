...
from launch_v100_hh_1n_factorization_20260418 import build_env, build_srun_cmd
...
def main() -> None:
    matrix = (
        REPO
        / "data/important_notes/optimization_track_20260418_v100_hh_1n_factorization/tables"
        / "v100_hh_1n_factorization_matrix_20260418_v100_hh_1n_factorization.csv"
    )
    row_1n = load_row(matrix, "v100fac_0001")

    env = build_env(row_1n, "355055", "fal101", 29671, "/tmp/factorizationtest")
    ...
    print("V100_HH_1N_FACTORIZATION_LAUNCH_TEST_OK")
