...
DATE_TAG = "20260419_v100_hh_track4_efficientnet_objective_tuning_c"
...
MATRIX_CSV = TABLES / f"v100_hh_track4_efficientnet_objective_tuning_c_matrix_{DATE_TAG}.csv"
NOTES_MD = NOTES / f"v100_hh_track4_efficientnet_objective_tuning_c_notes_{DATE_TAG}.md"
...
def main() -> None:
    ...
    variants = {
        "avgpool_baseline": {
            "description": "Track4 EfficientNet objective tuning C baseline: beta=0.05 inverse_std.",
            "type": '"EfficientNet"',
            "dropout": "0.1",
        ...
        "effnet_beta003_invstd": {
            "description": "Track4 EfficientNet objective tuning C candidate: beta=0.03 inverse_std.",
            "type": '"EfficientNet"',
            "dropout": "0.1",
            "target_loss_weight_mode": "inverse_std",
            "loss_type": "huber",
        ...
        "effnet_beta005_invvar": {
            "description": "Track4 EfficientNet objective tuning C candidate: beta=0.05 inverse_var.",
            "type": '"EfficientNet"',
            "dropout": "0.1",
        ...
        "effnet_beta007_invstd": {
            "description": "Track4 EfficientNet objective tuning C candidate: beta=0.07 inverse_std.",
            "type": '"EfficientNet"',
            "dropout": "0.1",
            "target_loss_weight_mode": "inverse_std",
            "loss_type": "huber",
    ...
    for seed in [1046, 1047]:
        for strategy_id, variant in variants.items():
            ...
            updates = {
                "description": f'"{track_key} {strategy_id} efficientnet objective tuning c {DATE_LABEL}"',
                "type": variant["type"],
            ...
            rows.append(
                {
                    "row_id": f"v100t4effo_{row_num:04d}",
                    "phase": "phaseAH_track4_efficientnet_objective_tuning_c",
                    "phase_label": "Track4 EfficientNet objective tuning C",
                    "launch_mode": "dedicated_1x1n",
                    "launch_group": "",
                    "family": "track4_efficientnet_objective_tuning_c",
                    "track_key": track_key,
                    "policy": "strong",
                    "nodes": "1",
                    "gpus_per_node": "2",
                    ...
                    "notes": "Sequential one-node refinement around the leading EfficientNet recipe.",
                }
            )
    ...
    notes = [
        f"# V100 HH Track4 EfficientNet Objective Tuning C ({DATE_LABEL})",
        "",
        f"- matrix csv: `{MATRIX_CSV}`",
        f"- rows: `{len(rows)}`",
        "",
        "## Purpose",
        "- refine the leading EfficientNet recipe with finer Huber beta and alternative target weighting",
        "",
        "## Variants",
