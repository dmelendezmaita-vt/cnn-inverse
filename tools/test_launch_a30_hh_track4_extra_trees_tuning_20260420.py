...
from launch_a30_hh_track4_extra_trees_tuning_20260420 import build_env, build_srun_cmd
...
def main() -> None:
    matrix = (
        REPO
        / "data/important_notes/optimization_track_20260420_a30_hh_track4_extra_trees_tuning/tables"
        / "a30_hh_track4_extra_trees_tuning_matrix_20260420_a30_hh_track4_extra_trees_tuning.csv"
    )
    row = load_row(matrix, "a30t4tree_0001")

    env = build_env(row, Path("/tmp/a30t4treetest"))
    ...
    print("A30_HH_TRACK4_EXTRA_TREES_TUNING_LAUNCH_TEST_OK")
