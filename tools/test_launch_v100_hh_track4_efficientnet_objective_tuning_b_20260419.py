...
from launch_v100_hh_track4_efficientnet_objective_tuning_b_20260419 import build_env, build_srun_cmd
...
def main() -> None:
    matrix = (
        REPO
        / "data/important_notes/optimization_track_20260419_v100_hh_track4_efficientnet_objective_tuning_b/tables"
        / "v100_hh_track4_efficientnet_objective_tuning_b_matrix_20260419_v100_hh_track4_efficientnet_objective_tuning_b.csv"
    )
    row = load_row(matrix, "v100t4efob_0001")

    env = build_env(row, "355055", "fal101", 29671, Path("/tmp/t4efobtest"))
    ...
    print("V100_HH_TRACK4_EFFICIENTNET_OBJECTIVE_TUNING_B_LAUNCH_TEST_OK")
