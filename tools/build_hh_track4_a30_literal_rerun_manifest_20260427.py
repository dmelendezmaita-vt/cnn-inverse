...
IMPORTANT = REPO / "evidence" / "canonical_chain"
PYTHON_BIN = Path("/projects/neuro-collab/conda/neuro-collab-env/bin/python")
SHARED_DATA_SCRIPT = REPO / "tools" / "shared_data_utils.py"
GPU_STEP_SCRIPT = REPO / "tools" / "run_v100_interactive_step_20260411.sh"
CPU_STEP_SCRIPT = REPO / "tools" / "run_classical_baseline_step_20260420.sh"

CAMPAIGN_NAME = "hh_track4_a30_literal_rerun_20260427"
DEFAULT_OUT_ROOT = IMPORTANT / "20_hh_canonical_clean_a30" / "optimization_track_20260427_hh_track4_a30_literal_rerun"
...
def derive_launcher_script(matrix_csv: Path) -> Path:
    ...
    launcher = REPO / "tools" / f"launch_{prefix}_{date}.py"
