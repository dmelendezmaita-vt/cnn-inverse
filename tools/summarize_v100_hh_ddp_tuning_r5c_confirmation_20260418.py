...
SUMMARY_JSON = NOTES / f"v100_hh_ddp_tuning_r5c_confirmation_summary_{DATE_TAG}.json"
SUMMARY_MD = NOTES / f"v100_hh_ddp_tuning_r5c_confirmation_summary_{DATE_TAG}.md"
...
def main():
    ...
    md = [
        f"# V100 HH DDP Tuning R5c Confirmation Summary ({DATE_TAG})",
        "",
