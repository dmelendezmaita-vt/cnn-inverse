...
from launch_v100_hh_track4_target_focus_followup_20260419 import build_env, build_srun_cmd
...
def main() -> None:
    matrix = (
        REPO
        / "data/important_notes/optimization_track_20260419_v100_hh_track4_target_focus_followup/tables"
        / "v100_hh_track4_target_focus_followup_matrix_20260419_v100_hh_track4_target_focus_followup.csv"
    )
    row = load_row(matrix, "v100t4tf_0001")

    env = build_env(row, "355055", "fal101", 29671, Path("/tmp/t4tftest"))
    ...
    print("V100_HH_TRACK4_TARGET_FOCUS_FOLLOWUP_LAUNCH_TEST_OK")
