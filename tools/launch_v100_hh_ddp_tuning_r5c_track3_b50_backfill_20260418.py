...
REGISTRY_CSV = TABLES / f"v100_hh_ddp_tuning_r5c_track3_b50_backfill_registry_{DATE_TAG}.csv"
RUN_LOG_JSON = NOTES / f"v100_hh_ddp_tuning_r5c_track3_b50_backfill_run_log_{DATE_TAG}.json"
