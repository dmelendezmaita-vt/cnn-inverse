...
from launch_a30_hh_track4_effnet_local_matrix_20260420 import build_env, build_srun_cmd
...
def main() -> None:
    matrix = (
        REPO
        / "data/important_notes/optimization_track_20260420_a30_hh_track4_effnet_local_matrix/tables"
        / "a30_hh_track4_effnet_local_matrix_matrix_20260420_a30_hh_track4_effnet_local_matrix.csv"
    )
    row = load_row(matrix, "a30t4mat_0001")

    env = build_env(row, "351880", "fal011", 29671, Path("/tmp/a30t4mattest"))
    ...
    print("A30_HH_TRACK4_EFFNET_LOCAL_MATRIX_LAUNCH_TEST_OK")
