...
NOTES_MD = NOTES / f"v100_hh_postlocalsgd_r3_notes_{DATE_TAG}.md"
...
def main() -> None:
        ...
        for nodes in [2, 4]:
            for variant_name, period, warmup_steps in variants:
                for seed in [971, 972, 973]:
                    ...
                    updates = {
                        "description": f'"{track_key} {variant_name} phase R3 post-local SGD {DATE_LABEL}"',
                    ...
                    rows.append(
                        {
                            "row_id": f"v100r3_{row_num:04d}",
                            "phase": "phaseR3_postlocalsgd",
                            "launch_mode": "dedicated",
                            "launch_group": "",
                            "family": "postlocalsgd_screen",
                            "track_key": track_key,
                            "policy": "strong",
                            "nodes": str(nodes),
                            "gpus_per_node": "2",
                            ...
                            "strategy_description": f"Post-local SGD with period={period} warmup_steps={warmup_steps}",
                            "params_file": cfg_rel,
                            "tar_path": meta["tar"],
                            ...
                            "notes": "Phase R3 hierarchical post-local SGD screen.",
                        }
                    )
    ...
    notes = [
        f"# V100 HH Post-Local SGD R3 Matrix ({DATE_LABEL})",
        "",
        ...
        "",
        "## Design",
        "- New package for Phase R3, separate from R2 replication",
