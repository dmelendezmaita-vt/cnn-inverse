...
from launch_a30_hh_track4_tuned_tree_robustness_20260421 import build_env, build_srun_cmd
...
def main() -> None:
    matrix = (
        REPO
        / "data/important_notes/optimization_track_20260421_a30_hh_track4_tuned_tree_robustness/tables"
    ...
    print("A30_HH_TRACK4_TUNED_TREE_ROBUSTNESS_LAUNCH_TEST_OK")
