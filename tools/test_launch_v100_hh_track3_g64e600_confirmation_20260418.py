...
from launch_v100_hh_track3_g64e600_confirmation_20260418 import build_env, build_srun_cmd
...
def main() -> None:
    matrix = (
        REPO
        / "data/important_notes/optimization_track_20260418_v100_hh_track3_g64e600_confirmation/tables"
        / "v100_hh_track3_g64e600_confirmation_matrix_20260418_v100_hh_track3_g64e600_confirmation.csv"
    )
    row_1n = load_row(matrix, "v100t3cf_0001")

    env = build_env(row_1n, "355055", "fal101", 29671, "/tmp/t3confirmtest")
    ...
    print("V100_HH_TRACK3_G64E600_CONFIRMATION_LAUNCH_TEST_OK")
