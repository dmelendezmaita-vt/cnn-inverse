...
REGISTRY_CSV = TABLES / f"v100_hh_ddp_tuning_r5c_confirmation_registry_{DATE_TAG}.csv"
RUN_LOG_JSON = NOTES / f"v100_hh_ddp_tuning_r5c_confirmation_run_log_{DATE_TAG}.json"
