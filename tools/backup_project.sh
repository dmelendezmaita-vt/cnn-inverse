...
REPO_EXCLUDES=(
  ...
  "other/*"
  ".codex/*"
  "code/github_prep/fhn_dnn-1-implementation-in-pytorch-public/data/*"
  "code/github_prep/fhn_dnn-1-implementation-in-pytorch-public/evidence/canonical_chain/**/logs/*"
  "code/github_prep/fhn_dnn-1-implementation-in-pytorch-public/evidence/canonical_chain/**/runs/*"
  "code/github_prep/fhn_dnn-1-implementation-in-pytorch-public/.git/*"
)
...
Examples:
  ...
  bash tools/backup_project.sh --scope repo --format tar.gz
