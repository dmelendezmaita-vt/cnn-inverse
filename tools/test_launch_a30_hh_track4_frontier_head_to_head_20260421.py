...
from launch_a30_hh_track4_frontier_head_to_head_20260421 import build_env, build_srun_cmd
...
def main() -> None:
    matrix = (
        REPO
        / "data/important_notes/optimization_track_20260421_a30_hh_track4_frontier_head_to_head/tables"
        / "a30_hh_track4_frontier_head_to_head_matrix_20260421_a30_hh_track4_frontier_head_to_head.csv"
    )
    row = load_row(matrix, "a30t4h2h_0001")

    env = build_env(row, Path("/tmp/a30t4h2htest"))
    ...
    print("A30_HH_TRACK4_FRONTIER_HEAD_TO_HEAD_LAUNCH_TEST_OK")
