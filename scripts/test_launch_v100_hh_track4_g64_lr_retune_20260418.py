...
from launch_v100_hh_track4_g64_lr_retune_20260418 import build_env, build_srun_cmd
...
def main() -> None:
    matrix = (
        REPO
        / "data/important_notes/optimization_track_20260418_v100_hh_track4_g64_lr_retune/tables"
        / "v100_hh_track4_g64_lr_retune_matrix_20260418_v100_hh_track4_g64_lr_retune.csv"
    )
    row_1n = load_row(matrix, "v100t4lr_0001")

    env = build_env(row_1n, "355055", "fal101", 29671, "/tmp/t4lrretunetest")
    ...
    print("V100_HH_TRACK4_G64_LR_RETUNE_LAUNCH_TEST_OK")
