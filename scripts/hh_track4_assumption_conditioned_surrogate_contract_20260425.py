...
DATE_TAG = "20260425"
OUT_ROOT = REPO / "runs" / "assumption_conditioned_surrogate_bundle"
...
TRACK4_FEATURES = REPO / ".prepared_data" / "concatenated_data" / "y"
...
def claim_guardrails() -> dict[str, Any]:
    return {
        ...
        "related_existing_scripts": [
            str(REPO / "scripts" / "run_hh_track4_assumption_conditioned_hybrid_refinement_20260425.py"),
            str(REPO / "scripts" / "run_hh_track4_assumption_conditioned_wasserstein_abc_20260425.py"),
        ],
    }
