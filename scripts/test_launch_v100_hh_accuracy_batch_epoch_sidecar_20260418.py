...
from launch_v100_hh_accuracy_batch_epoch_sidecar_20260418 import build_env, build_srun_cmd
...
def main() -> None:
    matrix = (
        REPO
        / "data/important_notes/optimization_track_20260418_v100_hh_accuracy_batch_epoch_sidecar/tables"
        / "v100_hh_accuracy_batch_epoch_sidecar_matrix_20260418_v100_hh_accuracy_batch_epoch_sidecar.csv"
    )
    row_1n = load_row(matrix, "v100be_0001")

    env = build_env(row_1n, "355055", "fal101", 29671, "/tmp/batchepochtest")
    ...
    print("V100_HH_ACCURACY_BATCH_EPOCH_SIDECAR_LAUNCH_TEST_OK")
