...
from launch_v100_hh_track4_weight_finalists_confirmation_20260419 import build_env, build_srun_cmd
...
def main() -> None:
    matrix = (
        REPO
        / "data/important_notes/optimization_track_20260419_v100_hh_track4_weight_finalists_confirmation/tables"
        / "v100_hh_track4_weight_finalists_confirmation_matrix_20260419_v100_hh_track4_weight_finalists_confirmation.csv"
    )
    row_1n = load_row(matrix, "v100t4wf_0001")

    env = build_env(row_1n, "355055", "fal101", 29671, "/tmp/t4weightfinaltest")
    ...
    print("V100_HH_TRACK4_WEIGHT_FINALISTS_CONFIRMATION_LAUNCH_TEST_OK")
