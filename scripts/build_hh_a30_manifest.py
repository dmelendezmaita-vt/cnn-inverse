...
WORKSPACE_NOTES = Path(
    os.environ.get(
        "NC_WORKSPACE_NOTES_ROOT",
        "/projects/neuro-collab/code/fhn_dnn-1-implementation-in-pytorch/data/important_notes",
    )
)
...
GPU_STEP_SCRIPT = REPO / "scripts" / "run_interactive_dnn_step.sh"
CPU_STEP_SCRIPT = REPO / "scripts" / "run_classical_baseline_step.sh"

CAMPAIGN_NAME = "hh_track4_a30_literal_rerun_20260427"
DEFAULT_OUT_ROOT = OUTPUTS / "hh_a30_canonical"
