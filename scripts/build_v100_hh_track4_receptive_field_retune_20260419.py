...
DATE_TAG = "20260419_v100_hh_track4_receptive_field_retune"
...
MATRIX_CSV = TABLES / f"v100_hh_track4_receptive_field_retune_matrix_{DATE_TAG}.csv"
NOTES_MD = NOTES / f"v100_hh_track4_receptive_field_retune_notes_{DATE_TAG}.md"
...
def main() -> None:
    ...
    variants = {
        ...
        "rf_deep_k5_beta0p1": {
            "description": "Track4 receptive-field retune: deeper stack with kernel5 stride2.",
    ...
    for seed in [1003, 1004]:
        group = f"track4_seed{seed}_receptive_field"
        for strategy_id, variant in variants.items():
            ...
            updates = {
                "description": f'"{track_key} {strategy_id} receptive-field retune {DATE_LABEL}"',
            ...
            rows.append(
                {
                    ...
                    "phase": "phaseT_track4_receptive_field_retune",
                    "phase_label": "Track4 receptive-field retune",
                    "launch_mode": "concurrent_4x1n",
                    "launch_group": group,
                    "family": "track4_receptive_field_retune",
                    "track_key": track_key,
                    "policy": "strong",
                    "nodes": "1",
                    "gpus_per_node": "2",
                    ...
                    "notes": "Structural follow-up after confirming huber_beta=0.1 as the track4 winner.",
                }
            )
    ...
    notes = [
        f"# V100 HH Track4 Receptive-Field Retune ({DATE_LABEL})",
        "",
        f"- matrix csv: `{MATRIX_CSV}`",
        f"- rows: `{len(rows)}`",
        "",
        "## Purpose",
        "- test receptive-field and temporal-compression changes around the confirmed track4 beta=0.1 winner",
        "",
        "## Variants",
        "- `rf_base_beta0p1`",
        "- `rf_kernel7_beta0p1`",
