    ...
    for task_id, label, extra, runtime in active_rows:
        ...
        add_task(
            ...
            base_task(
                task_id=task_id,
                label=label,
                command=python_command("scripts/run_hh_track4_assumption_conditioned_active_sequential_design_20260425.py", *extra),
    ...
    add_task(
        ...
        base_task(
            ...
            command=python_command(
                "scripts/run_hh_track4_assumption_conditioned_asnpe_20260426.py",
