...
OUT_ROOT = REPO / f"data/important_notes/advisor_packet_{DATE_TAG}/phase23_submission"
TABLES = OUT_ROOT / "tables"
NOTES = OUT_ROOT / "notes"

PLAN_CSV = TABLES / f"phase23_unified_submission_matrix_{DATE_TAG}.csv"
JOBS_CSV = TABLES / f"phase23_jobs_registry_{DATE_TAG}.csv"
RUN_LOG_JSON = NOTES / f"phase23_submission_run_log_{DATE_TAG}.json"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Submit unified phase2+phase3 matrix jobs.")
    parser.add_argument(
        "--lane",
        default="all",
        choices=["all", "phase2_confidence", "phase3_batch_knee"],
        help="submission lane filter",
    )
