...
SUMMARY_JSON = NOTES / f"v100_hh_datapath_redesign_r4_summary_{DATE_TAG}.json"
SUMMARY_MD = NOTES / f"v100_hh_datapath_redesign_r4_summary_{DATE_TAG}.md"
...
def main():
    ...
    md = [
        f"# V100 HH Datapath Redesign R4 Summary ({DATE_TAG})",
        "",
