...
Examples:
  bash scripts/restore_project.sh --archive /projects/neuro-collab/archives/fhn_dnn/fhn_dnn_backup_20260228_120000.tar
  bash scripts/restore_project.sh --archive /path/to/backup.tar --dry-run
  bash scripts/restore_project.sh --archive /path/to/backup.tar --backup-current always --yes
USAGE
}
