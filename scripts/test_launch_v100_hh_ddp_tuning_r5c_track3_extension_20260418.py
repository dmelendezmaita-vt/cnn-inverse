...
from launch_v100_hh_ddp_tuning_r5c_track3_extension_20260418 import build_env, build_srun_cmd
...
def main() -> None:
    matrix = (
        REPO
        / "data/important_notes/optimization_track_20260418_v100_hh_ddp_tuning_r5c_track3_extension/tables"
        / "v100_hh_ddp_tuning_r5c_track3_extension_matrix_20260418_v100_hh_ddp_tuning_r5c_track3_extension.csv"
    )
    ...
    print("V100_HH_DDP_TUNING_R5C_TRACK3_EXTENSION_LAUNCH_TEST_OK")
