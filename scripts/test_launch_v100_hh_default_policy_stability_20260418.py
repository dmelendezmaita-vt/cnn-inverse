...
from launch_v100_hh_default_policy_stability_20260418 import build_env, build_srun_cmd
...
def main() -> None:
    matrix = (
        REPO
        / "data/important_notes/optimization_track_20260418_v100_hh_default_policy_stability/tables"
        / "v100_hh_default_policy_stability_matrix_20260418_v100_hh_default_policy_stability.csv"
    )
    row_1n = load_row(matrix, "v100pols_0001")
    row_4n = load_row(matrix, "v100pols_0017")

    env = build_env(row_1n, "355055", "fal101", 29671, "/tmp/defaultpolicystabilitytest")
    ...
    print("V100_HH_DEFAULT_POLICY_STABILITY_LAUNCH_TEST_OK")
