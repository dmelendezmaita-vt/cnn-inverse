...
def parse_args() -> argparse.Namespace:
    ...
    ap.add_argument(
        "--stage1-run-dir",
        default="/projects/neuro-collab/code/fhn_dnn-1-implementation-in-pytorch/data/important_notes/optimization_track_20260425_hh_track4_run_all_literature_plan/runs/swyft_native_v100_20260425",
    )
