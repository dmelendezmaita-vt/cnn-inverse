...
from launch_v100_hh_track4_effnet_invvar_stability_20260420 import build_env, build_srun_cmd
...
def main() -> None:
    matrix = (
        REPO
        / "data/important_notes/optimization_track_20260420_v100_hh_track4_effnet_invvar_stability/tables"
        / "v100_hh_track4_effnet_invvar_stability_matrix_20260420_v100_hh_track4_effnet_invvar_stability.csv"
    )
    row = load_row(matrix, "v100t4eis_0001")

    env = build_env(row, "365889", "fal117", 29671, Path("/tmp/t4eistest"))
    ...
    print("V100_HH_TRACK4_EFFNET_INVVAR_STABILITY_LAUNCH_TEST_OK")
