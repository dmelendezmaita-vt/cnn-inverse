...
from launch_a30_hh_track4_classical_robustness_20260420 import build_env, build_srun_cmd
...
def main() -> None:
    matrix = (
        REPO
        / "data/important_notes/optimization_track_20260420_a30_hh_track4_classical_robustness/tables"
        / "a30_hh_track4_classical_robustness_matrix_20260420_a30_hh_track4_classical_robustness.csv"
    )
    row = load_row(matrix, "a30t4crob_0001")

    env = build_env(row, Path("/tmp/a30t4crobtest"))
    if env.get("BASELINE_NAME") != "extra_trees_200":
    ...
    print("A30_HH_TRACK4_CLASSICAL_ROBUSTNESS_LAUNCH_TEST_OK")
