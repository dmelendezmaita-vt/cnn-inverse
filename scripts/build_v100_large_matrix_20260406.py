...
SBATCH_SCRIPT = REPO / "scripts" / "slurm_v100_large_bucket.sbatch"
...
def main() -> None:
                    ...
                    for lr in learning_rates:
                        for sub_len in sub_lengths:
                            for seed in seeds:
                                ...
                                cfg_rel = (
                                    f"pytorch/configs/reruns_{DATE_TAG}_optfix/{track_key}/"
                                    f"{policy}/n{nodes}/"
    ...
    lines = [
        ...
        f"- Config root: `pytorch/configs/reruns_{DATE_TAG}_optfix/`",
