...
DATE_TAG = "20260420_a30_hh_track4_top3_confirmation"
...
MATRIX_CSV = TABLES / f"a30_hh_track4_top3_confirmation_matrix_{DATE_TAG}.csv"
NOTES_MD = NOTES / f"a30_hh_track4_top3_confirmation_notes_{DATE_TAG}.md"
...
def main() -> None:
    ...
    variants = {
        "effnet_beta003_invstd_e400": {
            "description": "Track4 A30 top-3 confirmation candidate: EfficientNet beta=0.03 inverse_std e400.",
            "type": '"EfficientNet"',
            "dropout": "0.1",
        ...
        "effnet_beta003_invvar_e400": {
            "description": "Track4 A30 top-3 confirmation candidate: EfficientNet beta=0.03 inverse_var e400.",
            "type": '"EfficientNet"',
            "dropout": "0.1",
        ...
        "effnet_beta005_invvar_e500": {
            "description": "Track4 A30 top-3 confirmation candidate: EfficientNet beta=0.05 inverse_var e500.",
            "type": '"EfficientNet"',
            "dropout": "0.1",
            "target_loss_weight_mode": "inverse_var",
            "loss_type": "huber",
    ...
    for seed in [1071, 1072, 1073, 1074]:
        group = f"track4_a30_top3_confirmation_seed_{seed}"
        for strategy_id, variant in variants.items():
            ...
            updates = {
                "description": f'"{track_key} {strategy_id} a30 top3 confirmation {DATE_LABEL}"',
                "type": variant["type"],
                "learning_rate": variant["learning_rate"],
                "epochs": variant.get("epochs", "400"),
            ...
            rows.append(
                {
                    "row_id": f"a30t4top_{row_num:04d}",
                    "phase": "phaseAP_track4_a30_top3_confirmation",
                    "phase_label": "Track4 A30 top-3 confirmation",
                    "launch_mode": "concurrent_3x1n",
                    "launch_group": group,
                    "family": "track4_a30_top3_confirmation",
                    "track_key": track_key,
                    "policy": "strong",
                    "nodes": "1",
                    "gpus_per_node": "2",
                    ...
                    "notes": "A30-side fresh-seed confirmation of the three strongest Track4 EfficientNet candidates from the local matrix.",
                }
            )
    ...
    notes = [
        f"# A30 HH Track4 Top-3 Confirmation ({DATE_LABEL})",
        "",
        f"- matrix csv: `{MATRIX_CSV}`",
        f"- rows: `{len(rows)}`",
        "",
        "## Purpose",
        "- confirm the three strongest Track4 EfficientNet candidates on fresh seeds",
        "",
        "## Variants",
        "- `avgpool_baseline`",
