...
BATCHES: Tuple[BatchDefinition, ...] = (
    ...
    BatchDefinition(
        ...
        suite="canonical_complete_smoke",
        scientific_role="engineering_support",
        summary="Runs reduced cache-enabled `interactive_dnn` launchers under both `copy_to_node` and `tar_in_place`, so the smoke suite covers the cache-path launcher family that the full execution-path batch depends on.",
        requires_hh_tar=True,
        requires_slurm=True,
        cluster_label="Falcon",
        min_nodes=4,
        ...
        steps=(
            BatchStep(
                ...
                kind="interactive_dnn",
                description="Cache-path smoke train with node-local extraction",
            ...
            BatchStep(
                ...
                kind="interactive_dnn",
                description="Cache-path smoke eval with node-local extraction",
                params_file="src/pytorch/configs/hh/params_dnn_tar_hh_smoke_cache.yaml",
                pass_curr=True,
                save_predictions="none",
            ...
            BatchStep(
                ...
                kind="interactive_dnn",
                description="Cache-path smoke train with tar-in-place access",
                params_file="src/pytorch/configs/hh/params_dnn_tar_hh_smoke_cache.yaml",
                pass_curr=True,
                save_predictions="none",
                split_eval_after_train=True,
            ...
            BatchStep(
                ...
                kind="interactive_dnn",
                description="Cache-path smoke eval with tar-in-place access",
                params_file="src/pytorch/configs/hh/params_dnn_tar_hh_smoke_cache.yaml",
                pass_curr=True,
                save_predictions="none",
