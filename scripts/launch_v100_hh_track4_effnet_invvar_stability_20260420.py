...
REGISTRY_CSV = TABLES / f"v100_hh_track4_effnet_invvar_stability_registry_{DATE_TAG}.csv"
RUN_LOG_JSON = NOTES / f"v100_hh_track4_effnet_invvar_stability_run_log_{DATE_TAG}.json"
