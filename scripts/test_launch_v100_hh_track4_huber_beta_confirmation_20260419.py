...
from launch_v100_hh_track4_huber_beta_confirmation_20260419 import build_env, build_srun_cmd
...
def main() -> None:
    matrix = (
        REPO
        / "data/important_notes/optimization_track_20260419_v100_hh_track4_huber_beta_confirmation/tables"
        / "v100_hh_track4_huber_beta_confirmation_matrix_20260419_v100_hh_track4_huber_beta_confirmation.csv"
    )
    row_1n = load_row(matrix, "v100t4hbconf_0001")

    env = build_env(row_1n, "355055", "fal101", 29671, Path("/tmp/t4betaconfirmtest"))
    ...
    cmd_1n = build_srun_cmd("falcon", "355055", ["fal101"], row_1n)
    assert_flag(cmd_1n, "-M")
    assert_flag(cmd_1n, "falcon")
    ...
    print("V100_HH_TRACK4_HUBER_BETA_CONFIRMATION_LAUNCH_TEST_OK")
