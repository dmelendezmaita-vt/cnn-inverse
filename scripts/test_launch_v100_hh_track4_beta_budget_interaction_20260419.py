...
from launch_v100_hh_track4_beta_budget_interaction_20260419 import build_env, build_srun_cmd
...
def main() -> None:
    matrix = (
        REPO
        / "data/important_notes/optimization_track_20260419_v100_hh_track4_beta_budget_interaction/tables"
        / "v100_hh_track4_beta_budget_interaction_matrix_20260419_v100_hh_track4_beta_budget_interaction.csv"
    )
    row_1n = load_row(matrix, "v100t4bbi_0001")

    env = build_env(row_1n, "355055", "fal101", 29671, Path("/tmp/t4betabudgettest"))
    ...
    print("V100_HH_TRACK4_BETA_BUDGET_INTERACTION_LAUNCH_TEST_OK")
