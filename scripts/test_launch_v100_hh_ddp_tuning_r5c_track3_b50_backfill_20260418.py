...
from launch_v100_hh_ddp_tuning_r5c_track3_b50_backfill_20260418 import build_env, build_srun_cmd
...
def main() -> None:
    matrix = (
        REPO
        / "data/important_notes/optimization_track_20260418_v100_hh_ddp_tuning_r5c_track3_b50_backfill/tables"
        / "v100_hh_ddp_tuning_r5c_track3_b50_backfill_matrix_20260418_v100_hh_ddp_tuning_r5c_track3_b50_backfill.csv"
    )
    ...
    print("V100_HH_DDP_TUNING_R5C_TRACK3_B50_BACKFILL_LAUNCH_TEST_OK")
