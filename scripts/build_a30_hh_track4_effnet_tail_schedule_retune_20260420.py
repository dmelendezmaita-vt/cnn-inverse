...
DATE_TAG = "20260420_a30_hh_track4_effnet_tail_schedule_retune"
...
MATRIX_CSV = TABLES / f"a30_hh_track4_effnet_tail_schedule_retune_matrix_{DATE_TAG}.csv"
NOTES_MD = NOTES / f"a30_hh_track4_effnet_tail_schedule_retune_notes_{DATE_TAG}.md"
...
def main() -> None:
    ...
    variants = {
        "effnet_beta005_invstd_e400": {
            "description": "Track4 A30 EfficientNet tail schedule baseline: beta=0.05 inverse_std e400.",
            "type": '"EfficientNet"',
            "dropout": "0.1",
        ...
        "effnet_beta005_invvar_e400": {
            "description": "Track4 A30 EfficientNet tail schedule baseline: beta=0.05 inverse_var e400.",
            "type": '"EfficientNet"',
            "dropout": "0.1",
        ...
        "effnet_beta005_invstd_lowfloor": {
            "description": "Track4 A30 EfficientNet tail schedule candidate: beta=0.05 inverse_std low final lr.",
            "type": '"EfficientNet"',
            "dropout": "0.1",
            "target_loss_weight_mode": "inverse_std",
            "loss_type": "huber",
        ...
        "effnet_beta005_invvar_lowfloor": {
            "description": "Track4 A30 EfficientNet tail schedule candidate: beta=0.05 inverse_var low final lr.",
            "type": '"EfficientNet"',
            "dropout": "0.1",
            "target_loss_weight_mode": "inverse_var",
            "loss_type": "huber",
        ...
        "effnet_beta005_invvar_e500": {
            "description": "Track4 A30 EfficientNet tail schedule candidate: beta=0.05 inverse_var e500.",
            "type": '"EfficientNet"',
            "dropout": "0.1",
            "target_loss_weight_mode": "inverse_var",
            "loss_type": "huber",
        ...
        "effnet_beta005_invstd_e500": {
            "description": "Track4 A30 EfficientNet tail schedule candidate: beta=0.05 inverse_std e500.",
            "type": '"EfficientNet"',
            "dropout": "0.1",
            "target_loss_weight_mode": "inverse_std",
            "loss_type": "huber",
    ...
    for seed in [1067, 1068]:
        ...
        for variant_idx, (strategy_id, variant) in enumerate(variant_items):
            ...
            rows.append(
                {
                    "row_id": f"a30t4tail_{row_num:04d}",
                    "phase": "phaseAN_track4_a30_effnet_tail_schedule_retune",
                    "phase_label": "Track4 A30 EfficientNet tail schedule retune",
                    "launch_mode": "concurrent_3x1n",
                    "launch_group": group,
                    "family": "track4_a30_effnet_tail_schedule_retune",
                    "track_key": track_key,
                    "policy": "strong",
                    "nodes": "1",
                    "gpus_per_node": "2",
                    ...
                    "notes": "A30-side tail-schedule retune around the strongest EfficientNet objective variants.",
                }
            )
    ...
    notes = [
        f"# A30 HH Track4 EfficientNet Tail Schedule Retune ({DATE_LABEL})",
        "",
        f"- matrix csv: `{MATRIX_CSV}`",
        f"- rows: `{len(rows)}`",
        "",
        "## Purpose",
        "- test lower LR floors and intermediate schedule lengths for the strongest Track4 EfficientNet variants on A30",
        "",
        "## Variants",
        "- `avgpool_baseline`",
