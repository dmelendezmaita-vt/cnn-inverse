...
from launch_v100_hh_default_policy_20260418 import build_env, build_srun_cmd
...
def main() -> None:
    matrix = (
        REPO
        / "data/important_notes/optimization_track_20260418_v100_hh_default_policy/tables"
        / "v100_hh_default_policy_matrix_20260418_v100_hh_default_policy.csv"
    )
    row_1n = load_row(matrix, "v100pol_0001")
    row_4n = load_row(matrix, "v100pol_0009")

    env = build_env(row_1n, "355055", "fal101", 29671, "/tmp/defaultpolicytest")
    ...
    print("V100_HH_DEFAULT_POLICY_LAUNCH_TEST_OK")
