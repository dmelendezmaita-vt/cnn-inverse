...
LITERATURE_REFRESH = REPO / "scripts" / "analyze_hh_track4_a30_literature_surrogate_refresh_20260427.py"
HYBRID_APPEND = REPO / "scripts" / "append_hh_track4_a30_hybrid_tasks_20260427.py"
...
def main() -> None:
    ...
    add_py("a30runall__bayesflow_native_meanstd_v100_20260425", "phaseLIT_aligned_runall", "bayesflow_native_meanstd_v100_20260425", "scripts/run_hh_track4_aligned_multicurrent_bayesflow_20260425.py", ["--aggregation", "meanstd", "--seed", "20260425"], 240.0)
    add_py("a30runall__bayesflow_native_v100_20260425", "phaseLIT_aligned_runall", "bayesflow_native_v100_20260425", "scripts/run_hh_track4_aligned_multicurrent_bayesflow_20260425.py", ["--aggregation", "concat", "--seed", "20260425"], 260.0)
    add_py("a30runall__bayesflow_native_structured_currfusion_v100_20260425", "phaseLIT_aligned_runall", "bayesflow_native_structured_currfusion_v100_20260425", "scripts/run_hh_track4_aligned_multicurrent_bayesflow_structured_20260425.py", ["--structured-mode", "currfusion_chunkstats", "--seed", "20260425"], 260.0)
    add_py("a30runall__bayesflow_native_structured_currfusion_deltas_v100_20260425", "phaseLIT_aligned_runall", "bayesflow_native_structured_currfusion_deltas_v100_20260425", "scripts/run_hh_track4_aligned_multicurrent_bayesflow_structured_20260425.py", ["--structured-mode", "currfusion_chunkstats_deltas", "--seed", "20260425"], 260.0)
    add_py("a30runall__bayesflow_temporal_v100_20260426", "phaseLIT_aligned_runall", "bayesflow_temporal_v100_20260426", "scripts/run_hh_track4_aligned_multicurrent_bayesflow_temporal_20260426.py", ["--summary-network", "time_series_network", "--seed", "20260426"], 300.0)
    add_py("a30runall__bayesflow_temporal_transformer_v100_20260426", "phaseLIT_aligned_runall", "bayesflow_temporal_transformer_v100_20260426", "scripts/run_hh_track4_aligned_multicurrent_bayesflow_temporal_20260426.py", ["--summary-network", "time_series_transformer", "--seed", "20260426", "--time-points", "512", "--batch-size", "16", "--summary-dim", "32"], 420.0)
    add_py("a30runall__bayesflow_fusion_transformer_v100_20260426", "phaseLIT_aligned_runall", "bayesflow_fusion_transformer_v100_20260426", "scripts/run_hh_track4_aligned_multicurrent_bayesflow_temporal_20260426.py", ["--summary-network", "fusion_transformer", "--seed", "20260426", "--time-points", "512", "--batch-size", "16", "--summary-dim", "32"], 360.0)
    add_py("a30runall__bayesflow_set_posterior_v100_20260426", "phaseLIT_aligned_runall", "bayesflow_set_posterior_v100_20260426", "scripts/run_hh_track4_aligned_multicurrent_bayesflow_set_20260426.py", ["--summary-network", "set_transformer", "--seed", "20260426"], 260.0)
    add_py("a30runall__bayesflow_deepset_posterior_v100_20260426", "phaseLIT_aligned_runall", "bayesflow_deepset_posterior_v100_20260426", "scripts/run_hh_track4_aligned_multicurrent_bayesflow_set_20260426.py", ["--summary-network", "deep_set", "--seed", "20260426"], 260.0)
    add_py("a30runall__swyft_native_v100_20260425", "phaseLIT_aligned_runall", "swyft_native_v100_20260425", "scripts/run_hh_track4_aligned_multicurrent_swyft_20260425.py", ["--aggregation", "meanstd", "--seed", "20260425", "--device", "gpu"], 380.0)
    add_py("a30runall__swyft_native_concat_small_v100_20260425", "phaseLIT_aligned_runall", "swyft_native_concat_small_v100_20260425", "scripts/run_hh_track4_aligned_multicurrent_swyft_20260425.py", ["--aggregation", "concat", "--seed", "20260425", "--batch-size", "64", "--hidden-features", "64", "--num-blocks", "2", "--dropout", "0.05", "--disable-pairwise", "--device", "gpu"], 90.0)
    ...
    add_py("a30runall__swyft_tmnre_native_v100_20260425", "phaseLIT_aligned_runall", "swyft_tmnre_native_v100_20260425", "scripts/run_hh_track4_aligned_multicurrent_swyft_tmnre_20260425.py", ["--stage1-run-dir", str(save_dir("phaseLIT_aligned_runall", "swyft_native_v100_20260425")), "--aggregation", "meanstd", "--seed", "20260425", "--batch-size", "64", "--max-epochs", "20", "--device", "gpu"], 430.0, depends=["a30runall__swyft_native_v100_20260425"])
    add_py(
        "a30runall__swyft_tmnre_schedule_matrix_v100_20260425",
        "phaseLIT_aligned_runall",
        "swyft_tmnre_schedule_matrix_v100_20260425",
        "scripts/run_hh_track4_aligned_multicurrent_swyft_tmnre_schedule_matrix_20260425.py",
    ...
    add_py("a30runall__swyft_tmnre_structured_stage1_v100_20260425", "phaseLIT_aligned_runall", "swyft_tmnre_structured_stage1_v100_20260425", "scripts/run_hh_track4_aligned_multicurrent_swyft_tmnre_20260425.py", ["--stage1-run-dir", str(save_dir("phaseLIT_aligned_runall", "swyft_native_aligned_currents_pool_v100_20260425")), "--aggregation", "concat", "--model-variant", "aligned_currents_pool", "--structured-hidden-features", "96", "--seed", "20260425", "--batch-size", "64", "--max-epochs", "20", "--device", "gpu"], 220.0, depends=["a30runall__swyft_native_aligned_currents_pool_v100_20260425"])
    add_py("a30runall__swyft_tmnre_score_prune_structured_v100_20260426", "phaseLIT_aligned_runall", "swyft_tmnre_score_prune_structured_v100_20260426", "scripts/run_hh_track4_aligned_multicurrent_swyft_tmnre_score_prune_20260426.py", ["--stage1-run-dir", str(save_dir("phaseLIT_aligned_runall", "swyft_native_aligned_currents_pool_v100_20260425")), "--aggregation", "concat", "--seed", "20260426", "--device", "gpu"], 80.0, depends=["a30runall__swyft_native_aligned_currents_pool_v100_20260425"])
    add_py("a30runall__temporal_cnn_aligned_v100_20260426", "phaseLIT_aligned_runall", "temporal_cnn_aligned_v100_20260426", "scripts/run_hh_track4_aligned_multicurrent_temporal_cnn_20260426.py", ["--seed", "20260426"], 240.0)
    ...
    for task_id, label, extra, runtime in [
        ...
        cmd = python_command("scripts/run_hh_track4_assumption_conditioned_active_sequential_design_20260425.py", "--save-dir", str(run_root), *extra)
    ...
    for task_id, label, extra, runtime in [
        ...
        cmd = python_command("scripts/run_hh_track4_assumption_conditioned_asnpe_20260426.py", *extra)
    ...
    add_task(
        ...
        base_task(
            ...
            python_command(
                "scripts/run_hh_track4_swyft_trained_posterior_sbc_20260426.py",
                "--params", PARAMS_TRACK4,
    ...
    add_task(tasks, base_task("a30lit__generalized_bayes_npe_main_20260426", "phaseLIT_new_methods", "generalized_bayes_npe_main_20260426", python_command("scripts/run_hh_track4_assumption_conditioned_generalized_bayes_npe_20260426.py", "--save-dir", str(gen_root), "--seed", "20260426"), "cpu_only", 8, 0, 80.0, output_paths=[str(gen_root / "generalized_bayes_npe_manifest.json")], notes="bounded generalized-Bayes NPE adaptation"))
    for task_id, label, runtime in [
        ...
        add_task(tasks, base_task(task_id, "phaseLIT_new_methods", label, simformer_python_command("scripts/run_hh_track4_simformer_official_hh_20260426.py", "--save-dir", str(run_root)), "gpu1", 12, 1, runtime, output_paths=[str(run_root / "simformer_hh_metrics_summary.json")], notes="official upstream Simformer HH benchmark branch"))
    ...
    add_task(
        ...
        base_task(
            ...
            python_command("scripts/analyze_hh_track4_a30_literature_surrogate_refresh_20260427.py", "--campaign-root", str(CAMPAIGN_ROOT)),
            "cpu_only",
            4,
            0,
            60.0,
    ...
    add_task(
        ...
        base_task(
            ...
            "append_hybrid_tasks",
            python_command(
                "scripts/append_hh_track4_a30_hybrid_tasks_20260427.py",
                "--campaign-root",
                str(CAMPAIGN_ROOT),
                "--manifest-json",
                str(manifest_path),
