...
from launch_a30_hh_track4_extra_trees_targeted_confirmation_20260421 import build_env, build_srun_cmd
...
def main() -> None:
    matrix = (
        REPO
        / "data/important_notes/optimization_track_20260421_a30_hh_track4_extra_trees_targeted_confirmation/tables"
    ...
    print("A30_HH_TRACK4_EXTRA_TREES_TARGETED_CONFIRMATION_LAUNCH_TEST_OK")
