...
from launch_v100_hh_track4_split_strategy_retune_20260419 import build_env, build_srun_cmd
...
def main() -> None:
    matrix = (
        REPO
        / "data/important_notes/optimization_track_20260419_v100_hh_track4_split_strategy_retune/tables"
        / "v100_hh_track4_split_strategy_retune_matrix_20260419_v100_hh_track4_split_strategy_retune.csv"
    )
    row_1n = load_row(matrix, "v100t4sp_0001")

    env = build_env(row_1n, "355055", "fal101", 29671, "/tmp/t4splittest")
    ...
    print("V100_HH_TRACK4_SPLIT_STRATEGY_RETUNE_LAUNCH_TEST_OK")
