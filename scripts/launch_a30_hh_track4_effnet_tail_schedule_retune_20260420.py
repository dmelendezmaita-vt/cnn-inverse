...
REGISTRY_CSV = TABLES / f"a30_hh_track4_effnet_tail_schedule_retune_registry_{DATE_TAG}.csv"
RUN_LOG_JSON = NOTES / f"a30_hh_track4_effnet_tail_schedule_retune_run_log_{DATE_TAG}.json"
