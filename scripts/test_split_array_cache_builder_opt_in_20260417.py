...
def main() -> None:
    builder_paths = [
        REPO / "scripts/build_v100_interactive_followup_matrix_20260411.py",
        REPO / "scripts/build_v100_hh_scaling_redesign_matrix_20260412.py",
        REPO / "scripts/build_v100_hh_scaling_replication_r2_20260413.py",
        REPO / "scripts/build_v100_hh_postlocalsgd_r3_20260413.py",
        REPO / "scripts/build_v100_hh_postlocalsgd_r3_stable_20260413.py",
        REPO / "scripts/build_v100_hh_datapath_redesign_r4_20260416.py",
        REPO / "scripts/build_a100_hh_datapath_redesign_r4_20260416.py",
    ]
