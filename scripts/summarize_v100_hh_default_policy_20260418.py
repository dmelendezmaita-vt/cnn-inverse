...
SUMMARY_JSON = NOTES / f"v100_hh_default_policy_summary_{DATE_TAG}.json"
SUMMARY_MD = NOTES / f"v100_hh_default_policy_summary_{DATE_TAG}.md"
...
def main():
    ...
    md = [
        f"# V100 HH Default Policy Summary ({DATE_TAG})",
        "",
